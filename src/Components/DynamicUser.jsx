  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-white shadow-lg rounded-lg ">
      ...
      <div className="grid grid-cols-2 justify-between space-x-8">
        ...
        <div className="col-span- bg-gray-100 p-4 rounded-xl">
          ...
          <div className="space-y-2">
            ...
            <a className="font-semibold text-blue-800" href={`https://${data.website}`}>{data.website}</a>
          </div>
        </div>
        ...
        {/* Right Column: Address */}
          ...
          <div className="space-y-2">
              ...
              <p className="font-semibold text-gray-800">9{data.address.zipcode}874</p>
